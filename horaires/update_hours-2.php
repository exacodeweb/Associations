<!--<a href="./db_connect_horaires.php">-->
<?php
session_start();

// Vérifiez si l'utilisateur est connecté, sinon redirigez vers la page de connexion
if (!isset($_SESSION['username'])) {
    header('Location: ./admin_login-horaires-2.php');
    exit();
}

include './db_connect_horaires-2.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach ($jours as $jour) {
        ...
        /*$rowCount += $stmt->rowCount();//ajouter*/
    ...
    /*---------------------------*///ajouter
      ...
      /*if ($rowCount > 0) {
        ...
        $_SESSION['message'] = "Aucune modification apportée aux horaires.";
    }
...
<body>
    ...
    <nav>
        <ul>
            <!--<li><a href="../admin/admin_dashboard.php">Retour au Tableau de Bord</a></li>-->
            <li><a href="../admin/admin_dashboard2.php">Retour au Tableau de Bord</a></li>  
        </ul>
    </nav>
    <main>
