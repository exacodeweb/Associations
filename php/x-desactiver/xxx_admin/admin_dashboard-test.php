...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a class="nav-link" href="../php/admin_login-test.php">Gérer les avis</a></li>
    ...
    <main>
        ...
        <section>
            ...
            <div class="box-3">
                <ul>
                    <li><a href="create_event.php">Créer un utilisateur</a></li><!--Créer un Évènement-->
                    <li><a href="edit_event.php">Modifier un Utilisateur</a></li><!--Modifier un Évènement-->
                    <li><a href="delete_event.php">Supprimer un Utilisateur</a></li><!--Supprimer un Évènement-->
                </ul>
            </div>
        </section>
    </main>
