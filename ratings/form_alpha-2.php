...
/*
  ...
  /* Styles Responsive Design pour les petits écrans *//*
    @media screen and (max-width: 576px) {
  ...
  <div class="section-form">
    <div class="article">
      ...
      <!--  <div class="pt text-center">-->
        <p>
          Nous serions ravis de recevoir vos avis sur notre association. 
          Merci de prendre le temps de partager votre expérience avec nous.
        </p>
      <!--</div>-->
    </div>

    <form class="form" id="avis-form" action="./submit_ratings.php" method="post">
