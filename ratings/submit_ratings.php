...
// Récupérer les données du formulaire si la requête est POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Préparation de la requête d'insertion //avisusers
        $sql = "INSERT INTO user_feedback (name, email, message, note) VALUES (:name, :email, :message, :note)";
